            ...
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <div class="mt-1 text-sm text-gray-500 sm:max-w-2xl">
                    ...
                    @if ($author)
                        is created by
                        @if ($authorUrl)
                            <a class="hover:underline" href="{{ $authorUrl }}" rel="cc:attributionURL dct:creator">{{ $author }}</a>
                        @else
                    ...
                    @endif
                    is licensed under
                    <a class="hover:underline" href="https://creativecommons.org/licenses/by-sa/4.0" target="_blank" rel="noopener noreferrer">
