<footer class="py-4">
	<div class="container">
		<div class="row align-items-center py-4">
			<div class="col-12 col-lg-3 text-center text-lg-start mb-3 mb-lg-0"><img alt="Free Frontend Logo" class="img-fluid" height="" src="https://freefrontend.dev/wp-content/uploads/free-frontend-logo.png" width="300"></div>
		...
		<div class="pt-lg-4 pb-4 pb-lg-3 text-center small">
			...
			<p class="text-muted mb-0">© 2023 FreeFrontend.dev. All rights reserved.</p>
		</div>
	</div>
</footer>