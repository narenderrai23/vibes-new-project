...
class StarterUpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Update Vibes Healthcare Limited: pull Composer packages, check module migrations, run migrations, and clear caches';
    ...
    protected function displayHeader(): void
    {
        ...
        $this->line('╔════════════════════════════════════════════════════╗');
        $this->line('║                                                    ║');
        $this->line('║          <fg=bright-blue>Vibes Healthcare Limited Update</>                  ║');
        $this->line('║                                                    ║');
        $this->line('╚════════════════════════════════════════════════════╝');
        $this->newLine();
    }
