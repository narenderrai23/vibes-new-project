// Resolve base URL from meta tag set by Laravel's asset() helper
var _baseUrl = (document.querySelector('meta[name="base-url"]') || {}).content || '';
...
<div class="sidebar-contact">
    <div class="toggle-theme"  data-bs-toggle="offcanvas" data-bs-target="#theme-setting"><i class="ti ti-settings fa-w-16 fa-spin"></i></div>
    </div>
