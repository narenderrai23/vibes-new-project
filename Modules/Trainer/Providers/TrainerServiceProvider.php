...
{
    protected string $moduleName      = 'Trainer';
    protected string $moduleNameLower = 'trainer';
    ...
    public function boot(): void
    {
        ...
        $this->registerConfig();
        $this->registerViews();
        $this->loadMigrationsFrom(base_path('Modules/Trainer/database/migrations'));
        $this->loadRoutesFrom(base_path('Modules/Trainer/routes/web.php'));
    ...
    {
        $this->publishes([
            base_path('Modules/Trainer/Config/config.php') => config_path($this->moduleNameLower . '.php'),
        ], 'config');

        $this->mergeConfigFrom(
            base_path('Modules/Trainer/Config/config.php'),
    ...
    {
        $sourcePath = base_path('Modules/Trainer/Resources/views');
